# Simple & dirty X68000 16x16 tiles PNG pictures extractor.
...
def convert_tiles(png_name, pic_name, pal_name, sprites, off_pic, off_pal):
    ...
    global_pict_array = bytearray(int(sprites) * 16 * (16 * 16 * 3))
    global_pict_array = numpy.array(global_pict_array).reshape(16 * int(sprites),  (16 * 16 * 3))
        ...
        for j in range(int(sprites)):
            for k in range(16):
                ...
                for i in range(2):
                    ...
                    global_pict_array[k + (j * 16)][(i * 12) + (palette * 48)] = red[pixel1 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 1 + (palette * 48)] = green[pixel1 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 2 + (palette * 48)] = blue[pixel1 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 3 + (palette * 48)] = red[pixel2 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 4 + (palette * 48)] = green[pixel2 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 5 + (palette * 48)] = blue[pixel2 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 6 + (palette * 48)] = red[pixel3 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 7 + (palette * 48)] = green[pixel3 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 8 + (palette * 48)] = blue[pixel3 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 9 + (palette * 48)] = red[pixel4 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 10 + (palette * 48)] = green[pixel4 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 11 + (palette * 48)] = blue[pixel4 + (palette * 16)]
            off += 0x40
            for k in range(16):
                # Take 8 right pixels
                for i in range(2):
                    ...
                    pixel3 = (pixels & 0x00f0) >> 4
                    pixel4 = (pixels & 0x000f)
                    global_pict_array[k + (j * 16)][(i * 12) + 24 + (palette * 48)] = red[pixel1 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 1 + 24 + (palette * 48)] = green[pixel1 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 2 + 24 + (palette * 48)] = blue[pixel1 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 3 + 24 + (palette * 48)] = red[pixel2 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 4 + 24 + (palette * 48)] = green[pixel2 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 5 + 24 + (palette * 48)] = blue[pixel2 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 6 + 24 + (palette * 48)] = red[pixel3 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 7 + 24 + (palette * 48)] = green[pixel3 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 8 + 24 + (palette * 48)] = blue[pixel3 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 9 + 24 + (palette * 48)] = red[pixel4 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 10 + 24 + (palette * 48)] = green[pixel4 + (palette * 16)]
                    global_pict_array[k + (j * 16)][(i * 12) + 11 + 24 + (palette * 48)] = blue[pixel4 + (palette * 16)]
            off += 0x40
    print("Done.")
